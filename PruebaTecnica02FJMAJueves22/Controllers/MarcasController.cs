...
namespace PruebaTecnica02FJMAJueves22.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(PruebaTecnica02FJMAContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marcas != null ? 
                          ...
                          Problem("Entity set 'PruebaTecnica02FJMAContext.Marcas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PruebaTecnica02FJMAContext.Marcas'  is null.");
            }
            var marcas = await _context.Marcas.FindAsync(id);
            if (marcas != null)
            {
